    ...
    return (
        <div className="bg-white">
            <div className="link">
                ...
                <ul>
                    <li className="text-black"><strong>Developer</strong></li>
                    <li className="text-black">Erica C | <a href="https://github.com/chonger878">Github</a> | 
                    <a href="https://www.linkedin.com/in/charwaeericachong/">LinkedIn</a></li>
                    <li className="text-black">Frosty/Laura | <a href="https://github.com/frosty8104">Github</a> | 
                    <a href="https://www.linkedin.com/in/laura-gieg-web-designer-dev/">LinkedIn</a></li>
                    <li className="text-black">Bogdan Terzic | <a href="https://github.com/minorObsession">Github</a> | 
